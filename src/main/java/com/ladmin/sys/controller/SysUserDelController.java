...
@RestController
@RequestMapping("/user")
public class SysUserDelController {
	@Autowired
	SysUserDelService sysUserService;
	@RequestMapping("doFindUsers")
	public JsonResult doFindUsers(Integer pageCurrent,String username,String startTime,String endTime) {		
